...
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `create_update_result`( in FILTERtable varchar(2048), in KB_LIST varchar(2048), in createtbleresult int)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_datetime`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_updateclassification`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_updatecompagny`()
BEGIN
  DECLARE is_done INTEGER DEFAULT 0;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_updateproductfamily`()
BEGIN
  DECLARE is_done INTEGER DEFAULT 0;
  -- déclarer la variable qui va contenir les noms des clients récupérer par le curseur .
  DECLARE c_title varchar(2040)  DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_update_product`()
BEGIN
  DECLARE is_done INTEGER DEFAULT 0;
  -- déclarer la variable qui va contenir les noms des clients récupérer par le curseur .
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `update_update_remplaces`()
BEGIN
  DECLARE is_done INTEGER DEFAULT 0;
  -- déclarer la variable qui va contenir les noms des clients récupérer par le curseur .
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_create_product_tables`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_office_2003_64bit`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_office_2007_64bit`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_office_2010_64bit`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_office_2013_64bit`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_office_2016_64bit`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2005`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2008`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2010`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2012`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2013`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2015`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2017`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2019`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Vstudio_2022`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Win10_X64_1903`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Win10_X64_21H1`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Win10_X64_21H2`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Win11_X64`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `up_init_packages_Win_Malicious_X64`()
BEGIN
	DECLARE is_done INTEGER DEFAULT 0;
	DECLARE c_title varchar(2040)  DEFAULT "";
    DECLARE c_description varchar(2040)DEFAULT "";
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE OR REPLACE PROCEDURE `_add_new_remplace`(in uuid varchar(48), in c_supersedestxt varchar(2048) )
BEGIN
...
-- Dump completed on 2022-10-20 17:25:44

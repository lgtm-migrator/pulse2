...
# -- met a jour les produit
#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `update_update_product`;

#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `base_wsusscn2`.`update_update_product`;
#;
...
# -- mise a jour product family
#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `update_updateproductfamily`;

#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `base_wsusscn2`.`update_updateproductfamily`;
#;
...
#DELIMITER ;
#;
# -- mise a jour compagny
#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `update_updatecompagny`;

#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `base_wsusscn2`.`update_updatecompagny`;
#;
...
#USE `base_wsusscn2`;
#DROP procedure IF EXISTS `base_wsusscn2`.`update_update_remplaces`;
#;

...
#CONF_FILE="/etc/mmc/plugins/pulse2-genere_packageupdate.ini"

#directory_output_package = os.path.join("/", "media","jfk","linuxdata", "winupdate")
...
class download_packages:
    ...
    #def read_config(self):
        ...
        #self.port = "3307"
        #self.passwd = "mmc"
        #self.directory_output_package = os.path.join("/","var","lib","pulse2","packages","updates" )
            ...
            #if Config.has_option('generation_package', 'directory_output_package'):
                #self.directory_output_package = Config.get('generation_package', 'directory_output_package')
...
#def help():
    ...
    #print(
        #r"""Usage:-
    #%s  nametableproduit - download and generate product
    #%s  help  -  Displays this help""" %(sys.argv[0], sys.argv[0])
    #)
...
if __name__ == "__main__":
    ...
    #parser.add_option("-f", "--conffile", dest="CONF",
                      #default="/etc/mmc/plugins/pulse2-genere_packageupdate.ini",
                      #help="file de configuration")

    parser.add_option("-l", "--logfile", dest="logfile",
                      default="/var/log/mmc/pulse2-genere_packageupdate.log",
                      help="file de configuration")
    ...
    if opts.show_parametre:
        ...
        print ("\t\tpython3 ./pulse2-genere_packageupdate.py -d  -q -i\n")
        print ("\n\t test connection\n")
        print ("\t\tpython3 ./pulse2-genere_packageupdate.py -uroot -P 3306 -Hlocalhost -p siveo -q -t")
        ...
        print ("\t\tpython3 ./pulse2-genere_packageupdate.py -uroot -P 3306 -Hlocalhost -p siveo -q -t -d")
        print ("[2022-10-19 14:21:23,587] {pulse2-genere_packageupdate.py:444} INFO - try Connecting with parameters")
        print ("\thost: localhost")
        print ("\tuser: root")
        print ("\tport: 3306")
        print ("\tdb: xmppmaster\n")
        ...
        print ("\t\tpython3 ./pulse2-genere_packageupdate.py -p siveo -Tup_packages_Win10_X64_21H2 -o/var/lib/pulse2/packages/sharing/packages_Win10_X64_21H2 -q -d" )
        sys.exit(1)

...
#class xmppMasterthread(threading.Thread):
    ...
    #def doTask(self):
        #tg = xmppMasterConfig()
            ...
            #tg.debugmode = 50
        #logging.basicConfig(
            #level=tg.debugmode, format="[%(name)s.%(funcName)s:%(lineno)d] %(message)s"
        #)
        ## logging.log(tg.debugmode,"=======================================test log")
        #self.xmpp = MUCBot(tg)
        #self.xmpp.shutdown = False
        ...
        #self.xmpp.register_plugin(
            #"xep_0199",
            #{"keepalive": True, "frequency": 300, "interval": 300, "timeout": 200},
        #)

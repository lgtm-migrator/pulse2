...
import json
import zipfile
from pulse.package_server.types import File
from pulse.package_server.parser import PackageParser, PackageParserXML, PackageParserJSON
from pulse.package_server.find import Find
import pulse.utils
from pulse.package_server.utilities import md5file
from pulse.package_server.common.serializer import PkgsRsyncStateSerializer
from twisted.internet import reactor, task

class Common(pulse.utils.Singleton):
    """  Base class
    """
    ...
    def isPackageAccessible(self, pid):
        return (not pid in self.dontgivepkgs and not pid in self.need_assign and self.packages[pid].hasFile())

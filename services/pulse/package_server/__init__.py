...
from pulse.package_server.config import config_addons
...
#from pulse.package_server.imaging.tftp_server import ImagingTFTPServer
import pulse.utils
...
from pulse.version import getVersion, getRevision # pyflakes.ignore
...
class ThreadLauncher(pulse.utils.Singleton):
    def initialize(self, config):
        ...
        from pulse.package_server import thread_webserver

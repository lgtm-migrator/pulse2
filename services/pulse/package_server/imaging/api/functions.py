...
from pulse.package_server.config import P2PServerCP as PackageServerConfig
from pulse.package_server.imaging.api.client import ImagingXMLRPCClient
from pulse.package_server.imaging.cache import UUIDCache
from pulse.package_server.imaging.api.status import Status
from pulse.package_server.imaging.menu import isMenuStructure, ImagingDefaultMenuBuilder, ImagingComputerMenuBuilder, changeDefaultMenuItem, ImagingBootServiceItem, ImagingMulticastMenuBuilder, CleanMenu
from pulse.package_server.imaging.computer import ImagingComputerConfiguration
from pulse.package_server.imaging.iso import ISOImage
from pulse.package_server.imaging.archiver import Archiver
from pulse.package_server.imaging.rpcreplay import RPCReplay

from pulse.utils import isMACAddress, splitComputerPath, macToNode, isUUID, rfc3339Time, humanReadable, SingletonN, check_process, start_process, stop_process, normalizeMACAddressForPXELINUX
from pulse.apis import makeURL
from pulse.imaging.image import Pulse2Image
import json
import ConfigParser
...
class Imaging(object):
    ...
    def computerRegister(self, computerName, macAddress, imagingData = False, waitToBeInventoried=False):
        ...
        if not imagingData:
            ...
            if not self.computerPrepareImagingDirectory(cuuid, {'mac': macAddress, 'hostname': computerName}):
                return False
    ...
    def getComputerByMac(self, MACAddress):
        ...
        pulse.package_server.imaging.cache.UUIDCache()

...
"""
    pulse Package server types
"""

from pulse.package_server.utilities import md5sum
import pulse.package_server.common
import urllib
import locale
...
class AFiles:
    ...
    def toURI(self, mp = None):
        if mp == None:
            ...
            d = pulse.package_server.common.Common().h_desc(mp)

...
$refresh->display();
print "<br/><br/><br/>";
$ajax = new AjaxFilter(urlStrRedirect("xmppmaster/xmppmaster/ajaxstatusteamxmpp"), "container", array('login' => $_SESSION['login'], 'currenttasks' => '1'), 'formRunning'  );
...
print "<br/><br/><br/>";
$ajax1 = new AjaxFilter(urlStrRedirect("xmppmaster/xmppmaster/ajaxstatusteamxmppscheduler"), "container1", array('login' => $_SESSION['login']), 'formRunning1' );

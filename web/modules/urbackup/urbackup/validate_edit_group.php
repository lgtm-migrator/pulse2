...
//$name_data = htmlspecialchars($_GET["namedata"]);
//$value_data = htmlspecialchars($_GET["valuedata"]);
$name_data = "update_freq_incr";
$value_data = "18000";
$group_id = "-".$group_id;

//$users_group_array = xmlrpc_save_settings($group_id, $name_data, $value_data);
